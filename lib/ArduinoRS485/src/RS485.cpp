...
//RS485Class RS485(Serial1, 13, -1, -1);
RS485Class RS485(Serial1, 32, 12, -1);//m100 tx enable use gpio12(DE PIN)
//RS485Class RS485_2(Serial2, 13, 14, -1);//m100 tx enable use gpio12(DE PIN)
#endif
